...
function UKMresources() {
	...
	wp_enqueue_style('UKMresources_wp-admin', plugin_dir_url( __FILE__ ) .'js/UKMresources_wp-admin.css');
	...
	wp_enqueue_script('UKMresources_wp-adminJS', plugin_dir_url( __FILE__ ) .'js/UKMresources_wp-admin.js');
